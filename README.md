...
+с авторизацией, 
+без авторизации,
+Для обеих ситуаций нужно проверить, что любое поле можно изменить. Для неавторизованного пользователя — ещё и то, что система вернёт ошибку. БАГ, почта возвращается ту_ловер_кейс

Создание заказа:(параметризация)
+с авторизацией,
+без авторизации, БАГ
+с ингредиентами,
+без ингредиентов,
+с неверным хешем ингредиентов.БАГ
